...
sudo pacman -Syyu sxhkd bspwm vim neofetch thunar alacritty picom xorg-xrdb base-devel arandr xorg-server polybar zsh zsh-syntax-highlighting lsd zsh-autosuggestions feh xorg-xsetroot brightnessctl networkmanager pulseaudio alsa-utils pulseaudio-alsa lxappearance rofi
